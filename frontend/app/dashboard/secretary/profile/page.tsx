...
export default function SecretaryProfilePage() {
    ...
    return (
        <DashboardShell title="My Profile" description="Manage your account settings and preferences"
                        userRole="Secretary">
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-muted-foreground">Manage your notification
                                                preferences</p>
                                        </div>
                                    </div>
                                ...
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-muted-foreground">Manage your account
                                                settings</p>
                                        </div>
                                    </div>
                                    <ChevronRight className="h-4 w-4 text-muted-foreground"/>
                            ...
                            <TabsContent value="personal">
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>Update your personal details and contact
                                        ...
                                        <form id="personal-form" onSubmit={handlePersonalInfoSubmit}>
                                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <Input id="secretary-id" value={personalInfo.secretaryId} disabled/>
                                                </div>
                                            </div>
                                        </form>
                                    </CardContent>
                                                ...
                                                <div className="col-span-1 sm:col-span-2 space-y-2">
                                                    <div className="flex items-center justify-between space-x-2">
                                                        ...
                                                        <Switch
                                                            ...
                                                            onCheckedChange={(checked) => setVehicleInfo({
                                                                ...vehicleInfo,
                                                                isElectric: checked
                                                            })}
                                                        />
                                                    ...
                                                    <p className="text-xs text-muted-foreground">
                                                        Electric vehicles can park in rows A and F with free charging
                                                        stations.
                                                    </p>
                                                </div>
                                            </div>
                            ...
                            <TabsContent value="notifications">
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>Manage how you receive notifications and
                                            ...
                                            <div className="space-y-4">
                                                <div className="flex items-center justify-between space-x-2">
                                                    <div className="space-y-0.5">
                                                        <Label htmlFor="reservation-confirmation">Reservation
                                                            Confirmation</Label>
                                                        <p className="text-xs text-muted-foreground">
                                                    ...
                                                    <Switch
                                                        ...
                                                        onCheckedChange={(checked) =>
                                                            setNotifications({
                                                                ...notifications,
                                                                reservationConfirmation: checked
                                                            })
                                                        }
                                                    />
                                                </div>
                                                ...
                                                <div className="flex items-center justify-between space-x-2">
                                                    <div className="space-y-0.5">
                                                        <Label htmlFor="reservation-reminder">Reservation
                                                            Reminder</Label>
                                                        <p className="text-xs text-muted-foreground">
                            ...
                            <TabsContent value="preferences">
                                <Card>
                                    <CardHeader>
                                        ...
                                        <CardDescription>Set your default preferences for parking
                                            ...
                                            <div className="space-y-4">
                                                <div className="space-y-2">
                                                    ...
                                                    >
                                                        ...
                                                        <SelectContent>
                                                            ...
                                                            <SelectItem value="entrance">Near entrance (A01-A10,
                                                                F01-F10)</SelectItem>
                                                            <SelectItem value="middle">Middle section (B01-B10,
                                                                E01-E10)</SelectItem>
                                                            <SelectItem value="back">Back section (C01-C10,
                                                                D01-D10)</SelectItem>
                                                        </SelectContent>
                                                    </Select>
                                                    <p className="text-xs text-muted-foreground">
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    >
                                                        ...
                                                        <SelectContent>
                                                            <SelectItem value="full-day">Full day (8:00 AM - 6:00
                                                                PM)</SelectItem>
                                                            <SelectItem value="morning">Morning (8:00 AM - 1:00
                                                                PM)</SelectItem>
                                                            <SelectItem value="afternoon">Afternoon (1:00 PM - 6:00
                                                                PM)</SelectItem>
                                                        </SelectContent>
                                                    </Select>
                                                    <p className="text-xs text-muted-foreground">
